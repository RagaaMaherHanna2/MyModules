...
class IrAttachment(models.Model):
    ...
    def _compute_raw(self):
        url_records = self.filtered(lambda r: r.url and (r.url.startswith('https://redeemly-odoo.s3.me-south-1.amazonaws.com')or \
                                                         r.url.startswith('https://likecard-space.fra1.digitaloceanspaces.com')or \
                                                         r.url.startswith(
                                                             'https://skaral-bucket.s3.me-south-1.amazonaws.com')
                                                         )
                                    )
